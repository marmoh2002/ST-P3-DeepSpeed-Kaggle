...
class KalmanFilter(nn.Module):
    def __init__(self, F=None, B=None, H=None, Q=None, R=None, P=None, x0=None):
        ...
        self.Q = (
            nn.Parameter(
                torch.eye(h, w).view(1, h, w).expand(c, h, w), requires_grad=False
            )
            if Q is None
            else nn.Parameter(Q)
        )
        ...
        self.x = (
            nn.Parameter(torch.zeros(c, h, w), requires_grad=False)
            if x0 is None
    ...
    def update(self, z):
        ...
        I = (
            torch.eye(self.h, self.w)
            .view(1, self.h, self.w)
            .expand(self.c, self.h, self.w)
            .to(device=z.device)
        )
        tmp = I - K @ self.H
