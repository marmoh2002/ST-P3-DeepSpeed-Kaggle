...
class TrainingModule(pl.LightningModule):
    def __init__(self, hparams):
        ...
        self.profiler = None  # Add this line to initialize the profiler
    ...
    def training_step(self, batch, batch_idx):
        if self.profiler is not None:  # Check if profiler is initialized
            self.profiler.start("training_step")
        ...
        if self.profiler is not None:
            self.profiler.stop("training_step")
    ...
    def configure_optimizers(self):
        ...
        # Only optimize parameters that still require gradients
